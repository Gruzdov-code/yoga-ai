...
import {done, female} from "../../Assets/music";
import {CloseBtn} from "./particles";
import {Button} from "../../UIKit";
import Timer from "../Timer";
import style from "./Canvas.module.scss";

const Canvas = ({className, pose}) => {
                    ...
                    <div className={classNames(style.Modal)}>
                        <div className={classNames(style.ModalInner)}>
                            ...
                            <div className={classNames(style.ModalActions)}>
                                <Button className={classNames(style.ModalAction)} onClick={() => {
                                    navigate(-1);
                                }}>
                                    На главную
                                </Button>

                                <Button className={classNames(style.ModalAction)} accent onClick={() => {
